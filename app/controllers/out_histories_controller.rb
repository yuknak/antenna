class OutHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @out_history.save
        format.html { redirect_to @out_history, notice: 'Out history was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @out_history.update(out_history_params)
        format.html { redirect_to @out_history, notice: 'Out history was successfully updated.' }
  ...
  def destroy
    @out_history.destroy
    respond_to do |format|
      format.html { redirect_to out_histories_url, notice: 'Out history was successfully destroyed.' }
