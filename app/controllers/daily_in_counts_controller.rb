class DailyInCountsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @daily_in_count.save
        format.html { redirect_to @daily_in_count, notice: 'Daily in count was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @daily_in_count.update(daily_in_count_params)
        format.html { redirect_to @daily_in_count, notice: 'Daily in count was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to daily_in_counts_url, notice: 'Daily in count was successfully destroyed.' }
