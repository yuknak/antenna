class Admin::ArticleOutCountsController < Admin::Base
  ...
  def create
    ...
    respond_to do |format|
      if @article_out_count.save
        format.html { redirect_to admin_article_out_count_path(@article_out_count), notice: 'Article out count was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @article_out_count.update(article_out_count_params)
        format.html { redirect_to admin_article_out_count_path(@article_out_count), notice: 'Article out count was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_article_out_counts_url, notice: 'Article out count was successfully destroyed.' }
