class Admin::DailyOutCountsController < Admin::Base
  ...
  def create
    ...
    respond_to do |format|
      if @daily_out_count.save
        format.html { redirect_to admin_daily_out_count_path(@daily_out_count), notice: 'Daily out count was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @daily_out_count.update(daily_out_count_params)
        format.html { redirect_to admin_daily_out_count_path(@daily_out_count), notice: 'Daily out count was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_daily_out_counts_url, notice: 'Daily out count was successfully destroyed.' }
