class InHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @in_history.save
        format.html { redirect_to @in_history, notice: 'In history was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @in_history.update(in_history_params)
        format.html { redirect_to @in_history, notice: 'In history was successfully updated.' }
  ...
  def destroy
    @in_history.destroy
    respond_to do |format|
      format.html { redirect_to in_histories_url, notice: 'In history was successfully destroyed.' }
